...
const HeadToHead = () => {
  ...
  // Function to clear the operation timeout, defined in component scope
  ...
  useEffect(() => {
    ...
    if (!socket) {
      console.warn('HeadToHead: Socket is null, skipping event listeners');
      setLoading(false);
  ...
  }, [socket, updateQuestion, updateTimer, setResults, resetGame, mode, loading]);
